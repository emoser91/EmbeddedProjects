 ...
 * Analog inputs attached to pins A0 through A5 (optional)
 ...
 by Tom Igoe
  ...
  CHANGE Wifi SSD and Password in the arduino_secrets.h file. 
  DO NOT CHECK FILE INTO GIT WITH SSID AND PASSWORD!!

  WEBPAGE: To see data on the webpage, you will need to open a web browser and go to the IP Address given to the Arduino
  when i connects to the internet.
